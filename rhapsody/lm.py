"""
Rhapsody Text Language Model (~65M parameters).
...
This module is self-contained — no audio encoder or projector dependencies.
"""
...
class RotaryEmbedding(nn.Module):
    ...
    to every GroupedQueryAttention layer, saving repeated buffer memory.
    """
...
class GroupedQueryAttention(nn.Module):
    ...
    Accepts a *shared* RotaryEmbedding instance so that all layers
    re-use the same pre-computed cos/sin buffers.
    """
